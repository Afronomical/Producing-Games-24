...
//        ObjectiveTracker.instance.removed = false;
//        objectiveToAdd = "Collect medicine from storage";
...
//        ObjectiveTracker.instance.removed = false;
//        objectiveToAdd = "Find and Give patient 1 required medication";
...
//        ObjectiveTracker.instance.removed = false;
//        objectiveToAdd = "Use F clipboard and attend to patient 2";
...
//        ObjectiveTracker.instance.removed = false;
//        objectiveToAdd = "Attend to patient 3";
...
//            ObjectiveTracker.instance.removed = false;
//            objectiveToAdd = "Get back to Study";
...
//        {
//            ObjectiveTracker.instance.removed = false;
//            objectiveToAdd = "End shift at bed.";
...
//            storagedoorblock.SetActive(false);
//            ObjectiveTracker.instance.removed = false;
//            objectiveToAdd = "Get Exorcism GuideBook.";
...
//            demonbook = true;
//            ObjectiveTracker.instance.removed = false;
//            objectiveToAdd = "Save patient 2 from heart attack.";
...
//        {
//            ObjectiveTracker.instance.removed = false;
//            objectiveToAdd = "Find where patient 3 is hiding and escort them to bed.";
...
//        mainDoorblock.SetActive(false);
//            ObjectiveTracker.instance.removed = false;
//            objectiveToAdd = "Play organ to activate altar";
...
//        // Task13 = true;
//        ObjectiveTracker.instance.removed = false;
//        objectiveToAdd = "Place exorcism items on altar" +
